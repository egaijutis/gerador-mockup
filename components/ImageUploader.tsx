...
export const ImageUploader: React.FC<ImageUploaderProps> = ({ 
  ...
  return (
    <div className="w-full">
      ...
      {subLabel && <p className="text-slate-400 mb-4 text-sm">{subLabel}</p>}
      ...
      <div 
        className={`
          ...
          ${dragActive ? 'border-orange-500 bg-orange-500/10' : 'border-slate-700 bg-slate-800/50 hover:bg-slate-800'}
        `}
      ...
      >
        {currentImage ? (
          ...
          <div className="text-center">
            ...
            <p className="text-slate-300 font-medium mb-1">Arraste e solte sua imagem aqui</p>
            <p className="text-slate-500 text-sm mb-4">ou clique para buscar nos arquivos</p>
